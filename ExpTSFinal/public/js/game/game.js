...
// adicionando requisição ajax para enviar pontuação para o banco
function enviarPontuacao(pontos) {
	console.log(`Enviando pontuação ${pontos} para o servidor...`);
...
function gameOver() {
	...
	const placarFinal = parseInt(document.getElementById("score").textContent);
	enviarPontuacao(placarFinal);
